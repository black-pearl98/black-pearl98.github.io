...
(function () {
    ...
    var currentImageIndex, currentTextIndex, currentNumberIndex;
    ...
    var imageOptions = {
        ...
        piecesWidth: function () { return Pieces.random(30, 200); },
    ...
    slideGoto = function (num) {
        hideItems();
        currentIndex = num > slidesLength - 1? currentIndex: num;
        updateIndexes();
        showItems();
    }
...
function fetchEvent() {
    let link = `individial/?id=${currentIndex}`;
    window.location.href = link;
}

function makeAlertBox(text) {
